...
//(*IdInit(pp5Dialog)
const long pp5Dialog::ID_STATICTEXT1 = wxNewId();
const long pp5Dialog::ID_BUTTON1 = wxNewId();
const long pp5Dialog::ID_STATICLINE1 = wxNewId();
const long pp5Dialog::ID_BUTTON2 = wxNewId();
//*)

BEGIN_EVENT_TABLE(pp5Dialog,wxDialog)
    //(*EventTable(pp5Dialog)
    //*)
END_EVENT_TABLE()

pp5Dialog::pp5Dialog(wxWindow* parent,wxWindowID id)
{
    //(*Initialize(pp5Dialog)
    ...
    Connect(ID_BUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&pp5Dialog::OnAbout);
    Connect(ID_BUTTON2,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&pp5Dialog::OnQuit);
    //*)
}
...
void pp5Dialog::OnQuit(wxCommandEvent& event)
{
    Close();
}

void pp5Dialog::OnAbout(wxCommandEvent& event)
{
